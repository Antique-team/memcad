...
// Issue: the sub-memory needs be dropped during iterations
// this does not seem to happen.
// Crash due to a loss of pointers into the sub-memory.
// Those would be reasonably easy to handle.
// (I think it is not absolutely required to drop the offsets
//  in the sub-memory)
